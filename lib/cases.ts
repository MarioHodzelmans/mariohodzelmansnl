...
const aiNativeWebsiteCase: CaseSummary = {
  ...
  seo: {
    ...
    description:
      "A live case study showing how AI, Next.js, GitHub, Vercel, Puck, Payload CMS and Supabase work together in a modern website development workflow.",
  },
  contentHTML: `
...
export const fallbackCases: CaseSummary[] = [
  aiNativeWebsiteCase,
  {
    ...
    excerpt:
      "Designing AI-first operating structures that improve clarity, speed and decision-making.",
  ...
  },
  {
    ...
    excerpt:
      "Building a practical knowledge layer for reusable context, team memory and operational consistency.",
  ...
  },
  {
    ...
    excerpt:
      "Building scalable e-commerce workflows across markets, channels and internal operations.",
  ...
  },
  {
    ...
    excerpt:
      "Turning fragmented processes into smoother workflows that support real business growth.",
    featuredImage: "/img/works/showcase-sticky/pr04-01.webp",
    category: "AI Agents",
...
function ensureLivingCase(cases: CaseSummary[]): CaseSummary[] {
  const withoutDuplicate = cases.filter(
    (item) => item.slug !== aiNativeWebsiteCase.slug,
  );
